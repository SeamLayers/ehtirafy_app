class AppMockData {
  ...
  static final List<Map<String, dynamic>> mockFreelancerGigs = [
    {
      'id': 'gig-001',
      'title': 'تصوير حفلات زفاف مميز',
      'description':
          'تغطية شاملة لحفل الزفاف تشمل جميع اللحظات المميزة مع معدات عالية الجودة وخبرة 10 سنوات.',
      'price': 5000.0,
      'category': 'أفراح',
      'status': 'active',
    ...
    },
    {
      ...
      'title': 'جلسة تصوير عائلية',
      'description':
          'جلسة تصوير مميزة للعائلة في موقع خارجي أو استوديو مع تعديل دقيق للصور.',
      'price': 1500.0,
      'category': 'عائلات',
      'status': 'active',
    ...
    },
    {
      ...
      'description':
          'تصوير مميز للمنتجات للمتاجر الإلكترونية مع خلفية بيضاء وإضاءة مثالية.',
      'price': 2500.0,
      'category': 'منتجات',
      'status': 'pending',
